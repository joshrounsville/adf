  ...
  <div class="container relative">
    ...
    <div class="row">
      <div class="span6 span-m-8">
        <h1 class="pad-b--20 text-white text-uppercase">All Events</h1>
    ...
    <div class="row">
      <div class="span12">
        <ul class="list-inline-middle list-inline-spacer">
            ...
            <li>
              <a href="/upcoming-events/" class="btn btn--secondary btn--outline-gray btn--filter">Upcoming Events</a></li>
            <li>
              <a href="/past-events/" class="btn btn--secondary btn--outline-gray btn--filter">Past Events</a></li>
            <li>
              <a href="/all-events/" class="btn btn--secondary btn--outline-gray btn--filter active">All Events</a>
            </li>
        </ul>
      </div>
    </div>
