    ...
    <div class="row pad-t--30 js--equal-height-parent">
      <div class="span6">
        <div class="bg-white border-gray border-top--blue pad-v pad-h--20 border-radius js--equal-height">
          ...
          <p>During Spring and Summer Breaks come train with the best and take your game to a new level. Many of the area's best youth players are already training with Academia de Futeboltraining (ADF). Now it's your chance to join them and play soccer the Futeboltraining way!</p>
          <p>Participants learn moves and ball handling skills that will make them quicker and more creative players. ADF's approach builds a player's confidence by challenging them to learn not only moves and techniques, but to develop their own unique style and flair. Participants will find the experience both fun and rewarding as they learn to play the game from an entirely new perspective.</p>
        </div>
      </div>
      <div class="span6">
         <div class="bg-white border-gray border-top--blue pad-v pad-h--20 border-radius js--equal-height">
          ...
          <p>ADF chooses to participate in only a few select local, regional and national tournaments that expose players to the highest level of competition. Playing in a large number of tournaments is counterproductive to player development. ADF believes that players should spend the majority of their time training and recovering.</p>
          <p>Far too often players are exposed to endless matches, especially during the summer tournament season. This can be detrimental to a player’s body and development because they don’t get sufficient time to recover. By carefully selecting the tournaments in which to participate, ADF achieves the optimal balance of training, competing and recovering.</p>
        </div>
      </div>
    </div>
    ...
    <div class="row pad-t--30">
      <div class="span6">
        <div class="bg-white border-gray border-top--blue pad-v pad-h--20 border-radius">
          ...
          <p>Futsal is a valuable addition to a player’s training regime. Many of the world’s best soccer players started off playing futsal and credit futsal for aiding in their development. Futsal requires players to be creative and adept at maneuvering in tight spaces.</p>
...
<section class="bg-gray pad-v--2x">
  <div class="container">
    ...
    <div class="row">
      <div class="span12">
        <h2>Aspiring Collegiate and Professional players</h2>
      </div>
    </div>
